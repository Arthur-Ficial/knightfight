...
export const ARCHETYPES: readonly ArchetypeDef[] = [
  arch('squire', 'Squire', 1, 45, 24, { aggression: 0.25, feintChance: 0, tempo: 0.7, approachBias: 0.6 },
    'A slow high chop you can read and answer.',
    [mv('chop', 900, 80, 520, 9, 'white', 46, 'up')]),
  arch('bandit', 'Bandit', 2, 55, 28, { aggression: 0.55, feintChance: 0.1, tempo: 1.15, approachBias: 0.8 },
    'Fast side jabs - dodge the way they come.',
    [mv('jab', 420, 60, 300, 8, 'gold', 44, 'left'), mv('lunge', 520, 70, 340, 11, 'gold', 50, 'right')]),
  arch('man-at-arms', 'Man-at-Arms', 3, 70, 40, { aggression: 0.5, feintChance: 0.12, tempo: 1, approachBias: 0.7 },
  ...
  arch('shieldman', 'Shieldman', 4, 80, 90, { aggression: 0.35, feintChance: 0.1, tempo: 0.85, approachBias: 0.5 },
    ...
    [mv('bash', 620, 80, 420, 12, 'white', 44, 'up'), mv('shove', 700, 90, 460, 14, 'gold', 46, 'down')]),
  arch('twin-daggers', 'Twin Daggers', 5, 60, 32, { aggression: 0.7, feintChance: 0.2, tempo: 1.35, approachBias: 0.9 },
    'Rapid gold flurries - parry the rhythm.',
    [mv('flurry1', 360, 50, 220, 6, 'gold', 42, 'left', { canFeint: true }), mv('flurry2', 320, 50, 220, 7, 'gold', 42, 'right')]),
  arch('halberdier', 'Halberdier', 6, 85, 48, { aggression: 0.5, feintChance: 0.15, tempo: 0.9, approachBias: 0.3 },
    'Long reach and red low sweeps - dodge low.',
    [mv('thrust', 640, 80, 420, 13, 'white', 62, 'right'), mv('reap', 760, 100, 520, 20, 'red', 66, 'down')]),
  arch('crossbow', 'Crossbow Knight', 7, 65, 32, { aggression: 0.6, feintChance: 0.05, tempo: 0.8, approachBias: -0.7 },
    ...
    [mv('bolt', 700, 40, 520, 12, 'red', 200, 'right', { ranged: true }), mv('kick', 420, 60, 320, 9, 'white', 42, 'down')]),
  ...
  arch('black-knight', 'Black Knight', 10, 100, 52, { aggression: 0.55, feintChance: 0.25, tempo: 1.05, approachBias: 0.7 },
  ...
  arch('kingsguard', 'Kingsguard', 11, 105, 52, { aggression: 0.5, feintChance: 0.45, tempo: 1.1, approachBias: 0.6 },
  ...
  arch('champion', 'The Champion', 13, 160, 66, { aggression: 0.6, feintChance: 0.3, tempo: 1.1, approachBias: 0.75 },
  ...
  arch('dread-knight', 'Dread Knight', 14, 200, 76, { aggression: 0.65, feintChance: 0.4, tempo: 1.2, approachBias: 0.8 },
    'Endless boss. Every mechanic at once.',
    [mv('rime', 480, 60, 320, 15, 'gold', 50, 'up', { canFeint: true }), mv('doom', 760, 100, 500, 26, 'red', 56, 'down'), mv('volley', 680, 40, 480, 13, 'red', 200, 'right', { ranged: true })], 'allMechanics'),
];
